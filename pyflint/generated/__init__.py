...
# sources: common/flint_deployment.proto, common/port.proto, general/stack.proto, k8s/daemon_set.proto, k8s/deployment.proto, k8s/k8s_connection.proto, k8s/k8s_stack.proto, k8s/pod.proto, k8s/pvc.proto, k8s/secret.proto, k8s/service.proto, k8s/stateful_set.proto
...
class ConnectionTypes(betterproto2.Message):
    ...
    k8sconnection: "K8SConnection | None" = betterproto2.field(
...
class K8STypes(betterproto2.Message):
    ...
    statefulset: "StatefulSet | None" = betterproto2.field(
        7, betterproto2.TYPE_MESSAGE, optional=True, group="type"
    )

    daemonset: "DaemonSet | None" = betterproto2.field(
...
class Pod(betterproto2.Message):
    ...
    mounts: "list[VolumeMount]" = betterproto2.field(
...
class StackTypes(betterproto2.Message):
    ...
    k8sstack: "K8SStack | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, optional=True, group="type"
    )
...
class StatefulSet(betterproto2.Message):
    ...
    volume_claim_templates: "list[VolumeClaimTemplate]" = betterproto2.field(
        4, betterproto2.TYPE_MESSAGE, repeated=True
    )
...
class VolumeClaimTemplate(betterproto2.Message):
    ...
    access_modes: "list[AccessMode]" = betterproto2.field(
        2, betterproto2.TYPE_ENUM, repeated=True
    )

    storage_class_name: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)

    storage: "str" = betterproto2.field(4, betterproto2.TYPE_STRING)
...
class VolumeMount(betterproto2.Message):
    ...
    mount_path: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
