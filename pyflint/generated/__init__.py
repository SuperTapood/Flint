...
# sources: common/flint_deployment.proto, common/port.proto, general/stack.proto, k8s/deployment.proto, k8s/k8s_connection.proto, k8s/k8s_stack.proto, k8s/pod.proto, k8s/pvc.proto, k8s/secret.proto, k8s/service.proto, k8s/stateful_set.proto
