...
const file_general_stack_proto_rawDesc = "" +
    "\n" + 
    "\x13general/stack.proto\"C\n" + 
    "\n" + 
    "StackTypes\x12-\n" + 
    "\tK8S_stack\x18\x01 \x01(\x0b2\x0d.k8s.K8SStackH\x00R\tK8S_stackB\x06\n" + 
    "\x04type\"W\n" + 
    "\x0fConnectionTypes\x12<\n" + 
    "\x0eK8S_connection\x18\x01 \x01(\x0b2\x12.k8s.K8SConnectionH\x00R\x0eK8S_connectionB\x06\n" + 
    "\x04type\"p\n" + 
    "\x05Stack\x12\x12\n" + 
    "\x04name\x18\x01 \x01(\tR\x04name\x12!\n" + 
    "\x05stack\x18\x02 \x01(\x0b2\x0b.StackTypesR\x05stack\x120\n" + 
    "\n" + 
    "connection\x18\x03 \x01(\x0b2\x10.ConnectionTypesR\n" + 
    "connectionBCB\n" + 
...
var file_general_stack_proto_depIdxs = []int32{
    0, // 0: Stack.stacktypes:type_name -> StackTypes
    1, // 1: Stack.connectiontypes:type_name -> ConnectionTypes
