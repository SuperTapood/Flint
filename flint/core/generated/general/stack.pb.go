...
type StackTypes_K8SStack struct {
    K8SStack *k8s.K8SStack `protobuf:"bytes,1,opt,name=K8S_stack,proto3,oneof"`
}
...
type ConnectionTypes_K8SConnection struct {
    K8SConnection *k8s.K8SConnection `protobuf:"bytes,1,opt,name=K8S_connection,proto3,oneof"`
}
...
const file_general_stack_proto_rawDesc = "" +
    "\n" + 
    "\x13general/stack.proto\x1a\x13k8s/k8s_stack.proto\x1a\x18k8s/k8s_connection.proto\"C\n" + 
    "\n" + 
    "StackTypes\x12-\n" + 
    "\tK8S_stack\x18\x01 \x01(\v2\r.k8s.K8SStackH\x00R\tK8S_stackB\x06\n" + 
    "\x04type\"W\n" + 
    "\x0fConnectionTypes\x12<\n" + 
    "\x0eK8S_connection\x18\x01 \x01(\v2\x12.k8s.K8SConnectionH\x00R\x0eK8S_connectionB\x06\n" + 
    "\x04type\"p\n" + 
    "\x05Stack\x12\x12\n" + 
...
var file_general_stack_proto_goTypes = []any{
    ...
    (*Stack)(nil), // 2: Stack
    (*k8s.K8SStack)(nil), // 3: k8s.K8SStack
    (*k8s.K8SConnection)(nil), // 4: k8s.K8SConnection
}
var file_general_stack_proto_depIdxs = []int32{
    3, // 0: StackTypes.k8s.k8sstack:type_name -> k8s.K8SStack
    4, // 1: ConnectionTypes.k8s.k8sconnection:type_name -> k8s.K8SConnection
    0, // 2: Stack.stacktypes:type_name -> StackTypes
    1, // 3: Stack.connectiontypes:type_name -> ConnectionTypes
