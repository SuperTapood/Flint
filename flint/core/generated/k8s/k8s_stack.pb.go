...
type K8STypes_K8SLookup struct {
    K8SLookup *K8SLookup `protobuf:"bytes,5,opt,name=K8S_lookup,proto3,oneof"`
}

func (*K8STypes_K8SLookup) isK8STypes_Type() {}

type K8STypes_K8SOutput struct {
    K8SOutput *K8SOutput `protobuf:"bytes,6,opt,name=K8S_output,proto3,oneof"`
}

func (*K8STypes_K8SOutput) isK8STypes_Type() {}

type K8STypes_StatefulSet struct {
    StatefulSet *StatefulSet `protobuf:"bytes,7,opt,name=stateful_set,proto3,oneof"`
}

func (*K8STypes_StatefulSet) isK8STypes_Type() {}

type K8STypes_DaemonSet struct {
    DaemonSet *DaemonSet `protobuf:"bytes,8,opt,name=daemon_set,proto3,oneof"`
}
...
func (x *K8STypes) GetStatefulSet() *StatefulSet {
    if x != nil {
        if x, ok := x.Type.(*K8STypes_StatefulSet); ok {
...
type K8SOutputTypes_K8SLookup struct {
    K8SLookup *K8SLookup `protobuf:"bytes,1,opt,name=K8S_lookup,proto3,oneof"`
}

func (*K8SOutputTypes_K8SLookup) isK8SOutputTypes_Type() {}

type K8SOutputTypes_String struct {
    String string `protobuf:"bytes,2,opt,name=string,proto3,oneof"`
}

func (*K8SOutputTypes_String) isK8SOutputTypes_Type() {}
...
func (x *K8SOutputTypes) GetString() string {
    if x != nil {
        if x, ok := x.Type.(*K8SOutputTypes_String); ok {
            return x.String
        }
    }
    return ""
...
type K8SOutput struct {
    ...
    unknownFields protoimpl.UnknownFields
    sizeCache     protoimpl.SizeCache
    Types  []*K8SOutputTypes `protobuf:"bytes,1,opt,name=types,proto3" json:"types,omitempty"`
...
type K8SStack struct {
    ...
    unknownFields protoimpl.UnknownFields
    sizeCache     protoimpl.SizeCache
    Objects  []*K8STypes `protobuf:"bytes,1,opt,name=objects,proto3" json:"objects,omitempty"`
...
const file_k8s_k8s_stack_proto_rawDesc = "" +
    "\n" + 
    "\x13k8s/k8s_stack.proto\"\xe2\x02\n" + 
    "\bK8STypes\x12\x18\n" + 
    "\x03pod\x18\x01 \x01(\x0b2\x04.PodH\x00R\x03pod\x12$\n" + 
    "\x07service\x18\x02 \x01(\x0b2\b.ServiceH\x00R\x07service\x12-\n" + 
    "\n" + 
    "deployment\x18\x03 \x01(\x0b2\x0b.DeploymentH\x00R\n" + 
    "deployment\x12!\n" + 
    "\x06secret\x18\x04 \x01(\x0b2\x07.SecretH\x00R\x06secret\x12,\n" + 
    "\n" + 
    "K8S_lookup\x18\x05 \x01(\x0b2\n" + 
    ".K8SLookupH\x00R\n" + 
    "K8S_lookup\x12,\n" + 
    "\n" + 
    "K8S_output\x18\x06 \x01(\x0b2\n" + 
    ".K8SOutputH\x00R\n" + 
    "K8S_output\x122\n" + 
    "\x0cstateful_set\x18\x07 \x01(\x0b2\x0c.StatefulSetH\x00R\x0cstateful_set\x12,\n" + 
    "\n" + 
    "daemon_set\x18\b \x01(\x0b2\n" + 
    ".DaemonSetH\x00R\n" + 
    "daemon_setB\x06\n" + 
    "\x04type\"B\n" + 
    "\tK8SLookup\x12!\n" + 
    "\x06object\x18\x01 \x01(\x0b2\t.K8STypesR\x06object\x12\x12\n" + 
    "\x04keys\x18\x02 \x03(\tR\x04keys\"`\n" + 
    "\x0eK8SOutputTypes\x12,\n" + 
    "\n" + 
    "K8S_lookup\x18\x01 \x01(\x0b2\n" + 
    ".K8SLookupH\x00R\n" + 
    "K8S_lookup\x12\x18\n" + 
    "\x06string\x18\x02 \x01(\tH\x00R\x06stringB\x06\n" + 
    "\x04type\"X\n" + 
    "\tK8SOutput\x12%\n" + 
    "\x05types\x18\x01 \x03(\x0b2\x0f.K8SOutputTypesR\x05types\x12\x0e\n" + 
    "\x02ID\x18\x02 \x01(\tR\x02ID\x12\x14\n" + 
    "\x05index\x18\x03 \x01(\x05R\x05index\"M\n" + 
    "\bK8SStack\x12#\n" + 
    "\x07objects\x18\x01 \x03(\x0b2\t.K8STypesR\x07objects\x12\x1c\n" + 
    "\tnamespace\x18\x02 \x01(\tR\tnamespaceBBB\x0dK8sStackProtoP\x01Z/github.com/SuperTapood/Flint/core/generated/k8sb\x06proto3"
...
var file_k8s_k8s_stack_proto_depIdxs = []int32{
    0, // 0: K8SLookup.k8stypes:type_name -> K8STypes
    2, // 1: K8SOutput.k8soutputtypes:type_name -> K8SOutputTypes
    0, // 2: K8SStack.k8stypes:type_name -> K8STypes
    3, // [0:0] is the sub-list for method output_type
    3, // [0:0] is the sub-list for method input_type
    3, // [0:0] is the sub-list for extension type_name
