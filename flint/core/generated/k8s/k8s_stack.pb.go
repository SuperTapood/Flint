...
const file_k8s_k8s_stack_proto_rawDesc = "" +
    "\n" + 
    "\x13k8s/k8s_stack.proto\x1a\rk8s/pod.proto\x1a\x11k8s/service.proto\x1a\x14k8s/deployment.proto\x1a\x10k8s/secret.proto\x1a\x16k8s/stateful_set.proto\x1a\x14k8s/daemon_set.proto\"\xe2\x02\n" + 
    "\bK8STypes\x12\x18\n" + 
    "\x03pod\x18\x01 \x01(\v2\x04.PodH\x00R\x03pod\x12$\n" + 
    "\x07service\x18\x02 \x01(\v2\b.ServiceH\x00R\x07service\x12-\n" + 
    "\n" + 
    "deployment\x18\x03 \x01(\v2\v.DeploymentH\x00R\n" + 
    "deployment\x12!\n" + 
    "\x06secret\x18\x04 \x01(\v2\x07.SecretH\x00R\x06secret\x12,\n" + 
    "\n" + 
    "K8S_lookup\x18\x05 \x01(\v2\n" + 
    ".K8SLookupH\x00R\n" + 
    "K8S_lookup\x12,\n" + 
    "\n" + 
    "K8S_output\x18\x06 \x01(\v2\n" + 
    ".K8SOutputH\x00R\n" + 
    "K8S_output\x122\n" + 
    "\fstateful_set\x18\x07 \x01(\v2\f.StatefulSetH\x00R\fstateful_set\x12,\n" + 
    "\n" + 
    "daemon_set\x18\b \x01(\v2\n" + 
    ".DaemonSetH\x00R\n" + 
    "daemon_setB\x06\n" + 
    "\x04type\"B\n" + 
    "\tK8SLookup\x12!\n" + 
    ...
    "\bK8SStack\x12#\n" + 
    "\x07objects\x18\x01 \x03(\v2\t.K8STypesR\x07objects\x12\x1c\n" + 
...
var file_k8s_k8s_stack_proto_depIdxs = []int32{
    ...
    0, // 8: K8SLookup.k8stypes:type_name -> K8STypes
    1, // 9: K8SOutputTypes.k8slookup:type_name -> K8SLookup
    2, // 10: K8SOutput.k8soutputtypes:type_name -> K8SOutputTypes
    0, // 11: K8SStack.k8stypes:type_name -> K8STypes
